              ...
              <View
                ...
                <View>
                  <Image
                    ...
                    // alt={'No image'}
                    size="12"
                    style={{ borderRadius: 50, height: 54, width: 54, resizeMode: "cover" }}
                    source={item?.requestedImageUrl ? { uri: item.requestedImageUrl } : require('../../assets/ic_proile1.png')}
                          ...
                          <TouchableOpacity
                            onPress={() => {
                              this.setState({ activeTab: item }, () => {
                                ...
                                let filterredLeaveArr = [...this.state.filterredLeaveArr2];
